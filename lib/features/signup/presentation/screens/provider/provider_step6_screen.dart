...
/// Provider signup step 6 - ABN Verification
class ProviderStep6Screen extends ConsumerStatefulWidget {
  const ProviderStep6Screen({super.key});

  @override
  ConsumerState<ProviderStep6Screen> createState() =>
      _ProviderStep6ScreenState();
}

class _ProviderStep6ScreenState extends ConsumerState<ProviderStep6Screen> {
  ...
  Future<void> _handleVerify() async {
    ...
    try {
      ...
      if (response.success) {
        ...
        if (mounted) {
          context.go('/provider-signup/congratulation');
        }
      } else {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GradientBackground(
        showBackButton: true,
        onBackPressed: () => context.go('/provider-signup/step5'),
        child: Column(
          children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  'ABN verification is required for service providers in Australia',
                                  style: TextStyle(
                                    color: AppColors.primaryBlue,
                                    fontSize: 14,
                                  ),
