...
/// Provider signup step 5 - OTP Verification
class ProviderStep5Screen extends ConsumerStatefulWidget {
  const ProviderStep5Screen({super.key});

  @override
  ConsumerState<ProviderStep5Screen> createState() =>
      _ProviderStep5ScreenState();
}

class _ProviderStep5ScreenState extends ConsumerState<ProviderStep5Screen> {
  ...
  Future<void> _handleVerify() async {
    ...
    try {
      ...
      if (mounted) {
        context.go('/provider-signup/step6');
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: GradientBackground(
        showBackButton: true,
        onBackPressed: () => context.go('/provider-signup/step4'),
        child: Column(
          children: [
